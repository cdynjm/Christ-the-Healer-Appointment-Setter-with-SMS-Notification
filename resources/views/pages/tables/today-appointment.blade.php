            ...
            @if($ap->status == 0)
                ...
                @if(auth()->user()->type == 1)
                    ...
                    <td class="align-middle text-center">
                        @if(auth()->user()->type == 1)
                        <a href="javascript:;" id="check-appointment" class="text-secondary font-weight-bold text-xs"
                            data-toggle="tooltip" data-original-title="Edit user">
                            <i class="fas fa-check text-lg"></i>
                        </a>
                        <a href="javascript:;" id="failed-to-visit" class="text-secondary font-weight-bold text-xs ms-2"
                            data-toggle="tooltip" data-original-title="Edit user">
                            <i class="fas fa-xmark text-lg"></i>
                        </a>
                        @endif
                        <a href="javascript:;" id="view-appointment" class="text-secondary font-weight-bold text-xs ms-2"
                            data-toggle="tooltip" data-original-title="Edit user">
